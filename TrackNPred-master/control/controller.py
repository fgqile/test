...
class Controller:
    ...
    def connectControllers(self):
        ...
        # connect eval button
        self.view.evalButton.clicked.connect(self.handleEval)  # button的点击事件 https://blog.csdn.net/qq_28401855/article/details/104115326  https://blog.csdn.net/qq_37080133/article/details/86076338
        ## clear
    ...
    def handleTrain(self):
        ...
        self.updateBotLabel("") #pyqt5中的self.update()函数的作用，暂时想的是更新视图，等有了例子在贴出来
        #https://blog.csdn.net/zzzzlei123123123/article/details/103711394
        self.updateTopLabel("")
        self.setBotBar(0)
        self.setTopBar(0)
    ...
    def addToCanvas(self, text):
        self.view.canvas.insertHtml("<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; \
            margin-right:0px; -qt-block-indent:0; text-indent:0px;\">{}<br></p>".format(text))  # http://blog.sina.com.cn/s/blog_647a022e01016ikk.html
        self.view.canvas.verticalScrollBar().setValue(self.view.canvas.verticalScrollBar().maximum())
